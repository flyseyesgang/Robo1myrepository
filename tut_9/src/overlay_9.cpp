...
ImageOverlay()
    : Node("overlay_9")
{
    background_ = cv::imread("/home/vince/ros2_ws/src/tut_9/images/car_junction_gazebo.png", cv::IMREAD_UNCHANGED);
    foreground_ = map("/home/vince/ros2_ws/src/tut_9/images/car_junction_map2.pgm");
